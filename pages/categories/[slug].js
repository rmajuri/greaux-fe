...
import { Grid, Card, CardContent, Typography, Box, Link, InputLabel, Select, FormControl, MenuItem, Divider, Button } from "@mui/material"
                ...
                <CustomGrid item xs={12} md={9}>
                    { category ?
                        category.business.map(business => (
                            ...
                            <CustomCard onClick={() => handleBusinessClick(business)} key={business.url}>
                                <Box>
                                    <CardContent>
                                        <Grid container>
